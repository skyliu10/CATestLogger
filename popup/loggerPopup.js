function clicksHandler(event){
	...
	function restartRecording(backPage){
		backPage.callRestartCS();
	}
	...
	function callReportcaResult(backPage){
		backPage.reportcaResult();
	}
	...
	function callDownloadcaResult(backPage){
		backPage.downloadcaResult();
	}
	...
	switch(popupButton){
		...
		case 'imageViewIncidents':
			...
			break;
		case 'innercaResult':
		case 'imageViewcaResult':
			console.log(popupButton);
			allDisabled();
			recordFlag = 0;
			downloadFlag = 0;
			eventFlag = 0;
			background.then(callReportcaResult, onError);
			window.close();
			break;
		...
		case 'imageDownloadIncidents':
			...
			window.close();
			break;
		case 'divDownloadcaResult':
		case 'imageDownloadcaResult':
			background.then(callDownloadcaResult, onError);
			window.close();
			break;
